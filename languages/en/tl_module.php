...
$GLOBALS['TL_LANG']['tl_module']['news_filterStopLevel']       = array('Default filter stop level', 'Enter a value greater than 0 to expand the nesting depth of the categories filter.');
...
$GLOBALS['TL_LANG']['tl_module']['news_filterPrimaryCategory'] = array('Apply default filters based on primary news category', 'List only news whose primary category matches the default filter.');