...
$GLOBALS['TL_LANG']['tl_news_category']['hideInList']    = array('Hide in list module', 'Do not display category in the news list module (affects only the <em>news_</em> templates).');
