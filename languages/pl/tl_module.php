...
$GLOBALS['TL_LANG']['tl_module']['news_customCategories']      = array('Ogranicz wyświetlanie kategorii', 'Wybierz, które kategorie mają zostać wyświetlone.');
...
$GLOBALS['TL_LANG']['tl_module']['news_relatedCategories']     = array('Tryb powiązanych kategorii', 'Użyj kategorii aktywnej aktualności do filtrowania. Uwaga: moduł musi być na tej samej stronie co moduł czytnika aktualności.');
...
$GLOBALS['TL_LANG']['tl_module']['news_filterStopLevel']       = array('Domyślny poziom zatrzymania filtra', 'Wpisz wartość większą niż 0, aby zwiększyć głębokość zagnieżdżania filtru kategorii.');
...
$GLOBALS['TL_LANG']['tl_module']['news_filterPrimaryCategory'] = array('Zastosuj filtry domyślne w oparciu o podstawową kategorię wiadomości', 'Wyświetl tylko wiadomości, których główna kategoria odpowiada filtrowi domyślnemu.');