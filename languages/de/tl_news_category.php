...
$GLOBALS['TL_LANG']['tl_news_category']['hideInList']        = array('Im Listen/Archiv-Modul verstecken', 'Zeigt diese Kategorie nicht im Nachrichtenliste oder -archiv Modul an (wirkt sich nur auf die <em>news_</em> Templates aus).');
