...
$GLOBALS['TL_LANG']['tl_module']['news_filterPreserve']   = array('Mantieni il filtro default', 'Mantiene il filtro attivo anche se si seleziona una categoria.');
$GLOBALS['TL_LANG']['tl_module']['news_resetCategories']  = array('Link di reset', 'Aggiunge un link per resettare il filtro applicato alla lista news.');
