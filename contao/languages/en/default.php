...
$GLOBALS['TL_LANG']['MSC']['newsCategoriesPicker'] = 'Categories';

/*
 * Content elements
 */
$GLOBALS['TL_LANG']['CTE']['newsfilter'] = ['News module filtered', 'Adds a news module to the page with custom filter settings.'];
