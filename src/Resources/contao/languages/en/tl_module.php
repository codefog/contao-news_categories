...
$GLOBALS['TL_LANG']['tl_module']['news_filterCategoriesUnion'] = ['Filter using union (cumulative only)', 'Filter news and categories using union (x OR y) instead of intersection (x AND y).'];
